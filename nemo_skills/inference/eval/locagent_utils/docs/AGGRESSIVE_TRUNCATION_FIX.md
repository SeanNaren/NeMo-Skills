...
- `/mnt/ssd/htamoyan/NeMo-Skills/nemo_skills/inference/eval/locagent_utils/enhanced_context_management.py` - Contains the fix
- `/mnt/ssd/htamoyan/NeMo-Skills/nemo_skills/inference/eval/locagent_utils/test_truncation_fix.py` - Test script
