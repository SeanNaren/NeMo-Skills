# Artsiv Accurate Technical Guide

Based on actual code implementation in `artsiv.py`, `dialog_processor.py`, and `tool_executor.py`.
...
```
artsiv.py                      # Main orchestration, config
