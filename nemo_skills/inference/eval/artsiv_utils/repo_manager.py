"""
Repository management utilities for Artsiv.

This module provides functions for managing and visualizing repository structures:
- Filtering repository dictionaries by directories and file extensions
- Generating tree representations of repository structure
- Analyzing internal project dependencies
- Calculating ground truth coverage
"""
...
class RepoManager:
    ...
    def connected_tree_repo_dict(repo_dict: dict, target_file: str = None, show_line_counts: bool = False):
        ...
        Example output for specific file:
            ═══ nemo_skills/inference/eval/artsiv.py ═══

            → IMPORTS (3):
               • nemo_skills.inference.generate
               • nemo_skills.utils
               • .artsiv_utils.dialog_processor
